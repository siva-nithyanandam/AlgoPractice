...
public class ReverseNodesinKGroup {
  ...
  public static void main(String[] args) {
    ...
    ListNode res = o.reverseKGroup_iterative(listNode, 2);
  ...
  public ListNode reverseLinkedList_iterative(ListNode head, int k) {
  ...
  public ListNode reverseKGroup_iterative(ListNode head, int k) {
    ...
    while (ptr != null) {
      ...
      if (count == k) {
        ...
        ListNode revHead = this.reverseLinkedList_iterative(head, k);
