...
public class LastStoneWeightII {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(o.lastStoneWeightII_self(new int[]{7,4,9,18}));
    System.out.println(o.lastStoneWeightII_1ms(new int[]{4,3,4,3,2}));
    System.out.println(o.lastStoneWeightII_self(new int[]{4,3,4,3,2}));
    System.out.println(o.lastStoneWeightII_1ms(new int[]{2,7,4,1,8,1}));
    System.out.println(o.lastStoneWeightII(new int[]{2,7,4,1,8,1}));
    System.out.println(o.lastStoneWeightII_1ms(new int[]{3,2,1,7,3,7}));
