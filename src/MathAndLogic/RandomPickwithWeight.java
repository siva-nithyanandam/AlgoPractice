...
/**
 * Author - Sivaprakash Nithyanandam Timestamp - 6/26/2021  8:28 PM
 *
...
public class RandomPickwithWeight {
  ...
  public static void main(String[] args) {
    RandomPickwithWeight o = new RandomPickwithWeight();
    o.initiate(new int[]{1,9});
    System.out.println(o.pickIndex());
  }
  ...
  public int pickIndex_binary_search() {
